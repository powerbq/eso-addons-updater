...
<details>
<summary>Documentation in English</summary>
...
<details>
<summary>Dokumentation auf Deutsch</summary>
...
> поэтому внимательно выбирайте папку. Чтобы не потерять уже установленный список
...
<details>
<summary>Документація українською</summary>
